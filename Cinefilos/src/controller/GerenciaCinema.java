...
public class GerenciaCinema {
    ...
    public void adicionaFilmeEmCartaz(String nomeFilme, int duracao, int horario) {
        Filme novoFilme = new Filme(nomeFilme, duracao, horario);
    ...
    public List<String> getIngressosDisponiveis() {
        ...
        for (List<ProdutoIngressoCinema> ingresso : ingressosDoCinema) {
            for (ProdutoIngressoCinema prodIngresso : ingresso) {
                String chaveUnica = prodIngresso.getFilme().getNomeFilme() + " | "
                        + prodIngresso.getSala().getNomeSala() + " | " + prodIngresso.getHorario() + " | "
                        + "Cod: " + prodIngresso.getCodigo() + "| Ingressos disponiveis:  "
                        + quantidadeDeIngressosDisponiveis(prodIngresso.getCodigo());
    ...
    public static Produto getIngressoPorCodigo(String cod) {
        ...
        return null;
        // throw new IllegalArgumentException("Não existe ingresso com código
        // informado.");
    }
    ...
    public static void removeIngressoPorCodigo(String cod) {
        ...
        while (iterator.hasNext()) {
            ...
            // Se nenhum ingresso foi removido na iteração atual, verifica se a lista está
            // vazia
