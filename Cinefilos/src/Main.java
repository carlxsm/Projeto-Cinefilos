...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sistemaFacade.criaNovoFilme("As Crônicas de Nárnia", 180, 1400);
        sistemaFacade.adicionarNovoFilmeCinema(0, 0, 1430);
        sistemaFacade.adicionarNovoFilmeCinema(2, 0, 1430);

        sistemaFacade.criaNovoFilme("A Fuga das Galinhas", 210, 1200);
        sistemaFacade.adicionarNovoFilmeCinema(1, 1, 1430);

        sistemaFacade.criaNovoFilme("Shrek 2", 200, 1500);
        sistemaFacade.adicionarNovoFilmeCinema(2, 2, 1430);

        sistemaFacade.criaNovoFilme("Shrek 1", 200, 1700);
        ...
        do {
            ...
            switch (Sistema.scan.nextInt()) {
                case 1: // Login
                    // TODO acho que da pra colocar isso em algum controller e chamar 1 vez só pelo
                    // facade
                    ...
                    if (sistemaFacade.getTipoUsuarioLogado() == CategoriaUsuario.CLIENTE) {
                        while (Sistema.getLOGADO() != null) {
                            ...
                            System.out.println("1 - Filmes | 2 - Lanchonete | 3 - Fechar pedido | 4 - Deslogar"); // TODO
                                                                                                                  // fazer
                                                                                                                  // com
                                                                                                                  // que
                                                                                                                  // só
                            ...
                            switch (Sistema.scan.nextInt()) {
                                case 1: // exibição
                                    ...
                                    switch (Sistema.scan.nextInt()) {
                                        case 1: // comprar
                                            ...
                                            sistemaFacade.adicionaProdutoCarrinhoCompras(escolhaDoIngresso,
                                                    escolhaQuantidadeIngressos);
                                            sistemaFacade.teste();
                                ...
                                case 2: // exibição lanchonete
                                    ...
                                    switch (Sistema.scan.nextInt()) {
                                        case 1: // comprar
                                            ...
                                            sistemaFacade.adicionaProdutoCarrinhoCompras(escolhaDoProdutoLanchonete,
                                                    quantidadeProdutoLanchonete);
                                ...
                                case 3: // fechar pedido
                                    try {
                                        ...
                                        System.out.println("Total: R$" + sistemaFacade.finalizaCompra()); // TODO tentar
                                                                                                          // mandar isso
                                                                                                          // para um
                                                                                                          // método da
                                                                                                          // view
                    ...
                    // Menu gerente
                        ...
                        while (Sistema.getLOGADO() != null) {
                            System.out.println(
                                    "1 - Atualizar exibições | 2 - Atualiza Lanchonete | 3 - Relatório | 4 - Sair");
                            switch (Sistema.scan.nextInt()) {
                                ...
                                case 2: // Atualizar lanchonete
                                    sistemaFacade.exibeProdutosLanchoneteDisponiveis();
                                    System.out.println(
                                            "1 - Adiciona novo produto | 2 - Edita produto | 3 - Remove produto | 4- Sair");
                                    switch (sistemaFacade.entradaInteiro()) {
                                        case 1: // adiciona
                                            ...
                                            sistemaFacade.criaNovoProdutoLanchonete(nomeNovoProduto,
                                                    Double.parseDouble(precoNovoProduto), quantidadeNovoProduto);
                                            System.out.println("Produtos adicionados!");
                                            break;
                                        case 2: // edita
                                            ...
                                            System.out.println(
                                                    "1 - Editar nome do produto | 2 - Edita preço do produto | 3 - Editar quantidade do produto | 4- Sair");
                                            switch (Sistema.scan.nextInt()) {
                                                case 1: // editar nome
                                                    System.out.println("Digite o novo nome do produto");
                                                    String nomeProdutoEditadoNome = sistemaFacade.entradaString();
                                                    sistemaFacade.editaNomeProdutoLanchonete(nomeProdutoEditadoNome,
                                                            codigoProdutoEditado);
                                                    System.out.println("Produto editado!");
                                                    break;
                                                case 2: // Edita preco
                                                    System.out.println("Digite o novo nome do produto");
                                                    double precoProdutoEditado = Double
                                                            .parseDouble(sistemaFacade.entradaString());
                                                    sistemaFacade.editaPrecoProdutoLanchonete(precoProdutoEditado,
                                                            codigoProdutoEditado);
                                                    System.out.println("Produto editado!");
                                                    break;
                                                case 3:
                                                    ...
                                                    sistemaFacade.editaQuantidadeProdutoLanchonete(
                                                            quantidadeProdutoEditado, codigoProdutoEditado);
                                                    System.out.println("Produto editado!");
                                                    break;
                                                case 4:
                                                    break;
