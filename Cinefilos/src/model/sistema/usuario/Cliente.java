...
public class Cliente extends Usuario implements Serializable {
    ...
    public Cliente(String nome, String email, String senha) {
        super(nome, email, senha, CategoriaUsuario.CLIENTE);
    }

    // public List<Produto> getCarrinhoCompras() {
    // return carrinhoCompras.getCarrinhoDeCompras(); //TODO esse método está
    // duplicado, só sei que aqui tem getCarrinho e em CarrinhoDeCompras tb, o
    // correto seria apenas 1.
    // }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(carrinhoCompras, cliente.carrinhoCompras)
                && Objects.equals(programaFidelidade, cliente.programaFidelidade);
    }
